    ...
    <script type="text/javascript">
      ...
      function EndSelectExportForm(aryFields, filterSettings) {
        ...
        for (var i = 0; i < aryFields.length; i++) {
          ...
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '1_1') fieldList += " selected='selected'" ;
          fieldList += " >Ligne 1 - pos 1</option>";
          fieldList += "<option value='1_2' ";
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '1_2') fieldList += " selected='selected'" ;
          fieldList += ">Ligne 1 - pos 2</option>";
          fieldList += "<option value='1_3' ";
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '1_3') fieldList += " selected='selected'" ;
          fieldList += ">Ligne 1 - pos 3</option>";
          fieldList += "<option value='2_1' ";
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '2_1') fieldList += " selected='selected'" ;
          fieldList += ">Ligne 2 - pos 1</option>";
          fieldList += "<option value='2_2' ";
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '2_2') fieldList += " selected='selected'" ;
          fieldList += ">Ligne 2 - pos 2</option>";
          fieldList += "<option value='2_3' ";
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '2_3') fieldList += " selected='selected'" ;
          fieldList += ">Ligne 2 - pos 3</option>";
          fieldList += "<option value='3_1' ";
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '3_1') fieldList += " selected='selected'" ;
          fieldList += ">Ligne 3 - pos 1</option>";
          fieldList += "<option value='3_2' ";
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '3_2') fieldList += " selected='selected'" ;
          fieldList += ">Ligne 3 - pos 2</option>";
          fieldList += "<option value='3_3' ";
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '3_3') fieldList += " selected='selected'" ;
          fieldList += ">Ligne 3 - pos 3</option>";
          fieldList += "<option value='4_1' ";
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '4_1') fieldList += " selected='selected'" ;
          fieldList += ">Ligne 4 - pos 1</option>";
          fieldList += "<option value='4_2' ";
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '4_2') fieldList += " selected='selected'" ;
          fieldList += ">Ligne 4 - pos 2</option>";
          fieldList += "<option value='4_3' ";
          if(selected && selected[currentFormId] && selected[currentFormId]['export_field_' + meta_key] && selected[currentFormId]['export_field_' + meta_key] == '4_3') fieldList += " selected='selected'" ;
